...
const BlogCard = ({ date, year, title, excerpt }) => {
  ...
  return (
    <div
      className="bg-black/15 rounded-lg p-8  transition-colors cursor-pointer"
      onClick={() => {
        router.push("/blog");
      }}
    >
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Blog post title 1 text text text text texttext text text text text text text text text text text text text text text text text text text text text text text text text text text text text...",
    },
    {
      date: "11/02",
      year: "2024",
