...
const FeatureSection = () => {
  const features = [
    {
      ...
      description:
        "Always Here for You! Experience hassle-free gaming with our 24/7 Customer Support. Connect with us anytime, anywhere!",
    },
    {
      imageSrc: "/image/diamond.png",
      title: "Best Value & Fair Price",
      description:
        "Our marketplace offers unbeatable value for your money with exclusive deals on game keys, in-game currency, and more.",
    },
    {
      imageSrc: "/image/award.png",
      title: "Moneyback Guarantee",
      description:
        "Shop with Confidence! Our Moneyback Guarantee ensures your satisfaction with every purchase.",
    },
  ];
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/image/featureSection.png')", // Set the background image
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center py-7 relative z-10">
        ...
        <div className=" max-w-2xl text-center ">
          ...
          <h1 className="text-3xl md:text-2xl font-bold tracking-wide text-white mb-10 max-w-5xl mx-auto leading-10 ">
            More than 500,000 gamers trust{" "}
            <span className="text-fuchsia-500 ">masterloot</span> as their ideal
            supplier for online video game needs
          </h1>
