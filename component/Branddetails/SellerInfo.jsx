...
const SellerInfoCard = () => {
  ...
  return (
    <>
      <div
        className="p-4 rounded-lg relative h-48 bg-cover bg-center sm:h-56 "
        style={{ backgroundImage: "url('/image/sellerinfo-bg.png')" }}
      >
        <div className="flex justify-between items-center flex-wrap">
          <h2 className="text-lg font-bold text-fuchsia-500 sm:text-xl">
            Seller Information
          </h2>
        ...
        <div className="flex items-center gap-3 mt-3 flex-wrap">
          ...
          <div className="flex flex-col">
            <p className="text-sm font-bold flex items-center sm:text-2xl">
              boostroom <span className="text-blue-500 ml-1">✔️</span>
            </p>
            <p className="text-green-400 text-sm sm:text-base">
              {" "}
              100% Order Success Score
            </p>
      ...
      <div className="bg-dark-500 mt-4 text-white px-4 py-2 shadow-sm rounded-lg w-full max-w-md mx-auto">
        {/* Seller Information */}

        {/* Quantity Selector */}
        <div className="bg-dark-100  p-3 rounded-lg flex justify-between items-center">
          <button
        ...
        {/* Buy Now Button */}
        <button className="my-2 bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-6 rounded-sm w-full text-lg">
          BUY NOW
        </button>
