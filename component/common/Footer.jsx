        ...
        <div className="space-y-4">
          ...
          <div className="mt-6">
            ...
            <div className="flex space-x-4">
              ...
              <div className="w-8 h-8  rounded-md">
                <Image src={"/image/instragram1.png"} width={100} height={10} />
              </div>
              <div className="w-8 h-8 bg-white rounded-md">
                <Image src={"/image/tiktok.png"} width={100} height={10} />
              </div>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex space-x-4">
              ...
              <div className="w-8 h-8  rounded-md">
                <Image src={"/image/whatsapp1.png"} width={100} height={10} />
              </div>
              <div className="w-8 h-8  rounded-md">
                <Image src={"/image/messenger1.png"} width={100} height={10} />
              </div>
              <div className="w-8 h-8  rounded-md">
                <Image src={"/image/skype1.png"} width={100} height={10} />
              </div>
              <div className="w-8 h-8  rounded-md">
                <Image src={"/image/viber1.png"} width={100} height={10} />
              </div>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="space-y-4">
              <div className=" p-2 rounded-md w-48">
                <Image src={"/image/positivessl.jpg"} width={200} height={10} />
              </div>
              <div className=" p-2 rounded-md w-48">
                <Image src={"/image/googlesafe.jpg"} width={200} height={10} />
              </div>
              <div className="flex flex-col items-start ">
                ...
                <div className="flex mt-1">
                  {[...Array(5)].map((_, i) => (
                    <IoStar
                      key={i}
                      className="w-5 h-5 p-[2px]  fill-current mx-0.5 bg-[#21A96F] text-slate-300"
                    />
                  ))}
                </div>
              </div>
